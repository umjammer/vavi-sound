...
class YamahaMfiExclusiveTest {
    ...
    void voice() {
        ...
        byte[] exclusive = YamahaMfiExclusive.voice(0, 3, 0x41, 36, YamahaMfiExclusive.VoiceType.FM, image);
    ...
    void voiceType() {
        ...
        assertEquals(0, YamahaMfiExclusive.VoiceType.FM.ordinal());
        assertEquals(1, YamahaMfiExclusive.VoiceType.PCM.ordinal());
        assertEquals(2, YamahaMfiExclusive.VoiceType.AL.ordinal());
    }
    ...
    void wave() {
        ...
        byte[] exclusive = YamahaMfiExclusive.wave(3, adpcm);
    ...
    void packIsTheSameAsYamahaMessage() throws Exception {
        byte[] exclusive = YamahaMfiExclusive.voice(0, 0, 0x41, 0, YamahaMfiExclusive.VoiceType.PCM, new byte[16]);
    ...
    void packRoundTrip() throws Exception {
        YamahaMfiExclusiveCapture capture = new YamahaMfiExclusiveCapture();
        ...
        for (int length = 1; length < 64; length++) {
            ...
            capture.clear();
            YamahaMfiExclusive.send(capture, exclusive);
    ...
    @Test
    void sendToNothing() {
        YamahaMfiExclusive.send(null, YamahaMfiExclusive.wave(0, new byte[0]));
    }
}
