...
/**
 * MaFormatConversionProvider.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 201020 nsano initial version <br>
 */
public class MaFormatConversionProvider extends FormatConversionProvider {
    ...
    public AudioFormat.Encoding[] getSourceEncodings() {
        return new AudioFormat.Encoding[] { MaEncoding.MA, AudioFormat.Encoding.PCM_SIGNED };
    }
    ...
    public AudioFormat.Encoding[] getTargetEncodings(AudioFormat sourceFormat) {
        if (sourceFormat.getEncoding().equals(AudioFormat.Encoding.PCM_SIGNED)) {
            return new AudioFormat.Encoding[] { MaEncoding.MA };
        } else if (sourceFormat.getEncoding() instanceof MaEncoding) {
    ...
    public AudioFormat[] getTargetFormats(AudioFormat.Encoding targetEncoding, AudioFormat sourceFormat) {
        if (sourceFormat.getEncoding().equals(AudioFormat.Encoding.PCM_SIGNED) &&
            targetEncoding instanceof MaEncoding) {
        ...
        } else if (sourceFormat.getEncoding() instanceof MaEncoding && targetEncoding.equals(AudioFormat.Encoding.PCM_SIGNED)) {
            return new AudioFormat[] {
        ...
        if (isConversionSupported(targetEncoding, sourceStream.getFormat())) {
            ...
            if (formats != null && formats.length > 0) {
                ...
                if (sourceFormat.equals(targetFormat)) {
                    ...
                    return new Ma2PcmAudioInputStream(sourceStream, targetFormat, -1);
