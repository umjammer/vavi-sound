 ...
 * MFM {@code trac} chunk.
 *
 * @param number 0 origin, in order of appearance, rt_parser_std.dll plays 4 at most
 ...
 */
public record MfmTrack(int number, List<MfmEvent> events, boolean truncated) {
}
