 ...
 * "MTR*"
 *
 *  Format Type              : 1 byte (ïKê{)
 *  Sequence Type            : 1 byte (ïKê{)
 *  TimeBase_D               : 1 byte (ïKê{)
 *  TimeBase_G               : 1 byte (ïKê{)
 *  Channel Status           : n byte (ïKê{)(Format Type Ç…àÀë∂)
 *  Seek &amp; Phrase Info Chunk : n byte (Option)
 *  Setup Data Chunk         : n byte (Option)
 *  Sequence Data Chunk      : n byte (ïKê{)
 *  Stream PCM Data Chunk    : n byte (Option) (Format Type= &quot;Mobile Standard&quot; ÇÃèÍçáÇÃÇ›)
 * </pre>
