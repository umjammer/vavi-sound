 ...
 */
class VaviSmafSequencer implements Sequencer {

    private static final Logger logger = getLogger(VaviSmafSequencer.class.getName());

    /** the device information */
    static final Info info =
        new Info("Java SMAF Sound Sequencer",
                           "vavi",
