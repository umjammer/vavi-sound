...
import vavi.sound.smaf.vavi.chunk.TrackChunk;
...
logger.log(Level.DEBUG, "tracks: " + tracks.size() + ", " + tracks.getFirst().size());
        Track track0 = tracks.getFirst();
        String title = "title";
        String prot = "vavi";
...
logger.log(Level.DEBUG, dataChunk);
        ...
        track0.insert(new SmafEvent(metaMessage, 0), 0); // vn vendor name
        ...
        track0.insert(new SmafEvent(metaMessage, 0), 0); // st song title
    }
