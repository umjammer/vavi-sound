 ...
 * behind it - {@link YamahaMfiExclusive.VoiceType#AL} has no decoder anywhere, and a
...
public class Function1_240_8 extends ToneFunction {
    ...
    @Override
    YamahaMfiExclusive.VoiceType getVoiceType(Tone tone) {
        return tone.type == TYPE_WT ? YamahaMfiExclusive.VoiceType.PCM : YamahaMfiExclusive.VoiceType.FM;
    }
