...
public class Function2_241_13 implements MachineDependentFunction {
    ...
    public void process(MachineDependentMessage message)
        ...
        this.streamNumber =  0; // data[8] & 0x1f;        // stream number 0 ~ 31
        this.velocity =      data[9] & 0x7f;        // 0 ~ 127

logger.log(Level.DEBUG, "StreamOn?: " + channel + "ch, No." + streamNumber + ", velocity=" + velocity);
