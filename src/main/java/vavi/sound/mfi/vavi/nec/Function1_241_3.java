 ...
 */
public class Function1_241_3 implements MachineDependFunction {
...
Debug.println("StreamOn: " + channel + "ch, No." + streamNumber + ", velocity=" + velocity);
