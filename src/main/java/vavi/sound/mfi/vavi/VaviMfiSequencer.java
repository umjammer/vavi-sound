...
/**
 * MFi Sequencer implemented by vavi.
 * <p>
 ...
 */
class VaviMfiSequencer implements Sequencer {

    private static final Logger logger = getLogger(VaviMfiSequencer.class.getName());
