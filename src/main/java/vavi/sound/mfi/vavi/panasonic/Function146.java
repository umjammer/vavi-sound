...
/**
 * Panasonic System exclusive message function 0x92 processor.
 * (Voice Parameter)
 * <p>
 * The same message {@link vavi.sound.mfi.vavi.fujitsu.Function146} reads, the Panasonic MFi 4.0 plug in ({@code MFi4PlugIn_P}, {@code P_PlugIn}) writing the
 ...
 */
public class Function146 extends vavi.sound.mfi.vavi.fujitsu.Function146 {
