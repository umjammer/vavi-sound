...
/**
 * Panasonic System exclusive message function 0xb0 processor.
 * (sound source parameter 0)
 * <p>
 * The same message {@link vavi.sound.mfi.vavi.fujitsu.Function176} reads, the Panasonic MFi 4.0 plug in ({@code MFi4PlugIn_P}, {@code P_PlugIn}) writing the
