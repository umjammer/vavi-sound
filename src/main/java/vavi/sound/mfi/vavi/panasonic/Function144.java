...
/**
 * Panasonic System exclusive message function 0x90 processor.
 * (Wave Data)
 * <p>
 * The same message {@link vavi.sound.mfi.vavi.fujitsu.Function144} reads, the Panasonic MFi 4.0 plug in ({@code MFi4PlugIn_P}, {@code P_PlugIn}) writing the
