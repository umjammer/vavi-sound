...
/**
 * Panasonic System exclusive message function 0xa0 processor.
 * (sound source wide setting)
 * <p>
 * The same message {@link vavi.sound.mfi.vavi.fujitsu.Function160} reads, the Panasonic MFi 4.0 plug in ({@code MFi4PlugIn_P}, {@code P_PlugIn}) writing the
 ...
 */
public class Function160 extends vavi.sound.mfi.vavi.fujitsu.Function160 {
