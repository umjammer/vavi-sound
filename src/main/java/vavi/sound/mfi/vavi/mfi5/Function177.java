...
/**
 * MFi 5 System exclusive message function 0xb1 processor.
 * (sound source parameter 1)
 * <p>
 * The same message {@link vavi.sound.mfi.vavi.fujitsu.Function177} reads: the MFi 5
 * writer puts the 0xb1 of the MFi 4.0 plug ins under the vendor byte {@code 0x01}. The
